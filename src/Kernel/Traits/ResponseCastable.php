...
trait ResponseCastable
{
     ...
     *
     * @return array|\Spring\TouTiao\Kernel\Support\Collection|object|\Psr\Http\Message\ResponseInterface|string
     */
